    ...
    <div class="card shadow-sm p-4 rounded-4" style="max-width: 420px; width: 100%;">
        ...
        <form method="GET" action="{{ route('simulate.login') }}">
            <div class="mb-3">
                ...
                <input type="text" name="role" id="role" class="form-control form-control-sm" placeholder="Enter 'admin' or 'user'" required>
            </div>

            <div class="mb-3">
                <label for="password" class="form-label small fw-semibold">Password</label>
                <input type="password" class="form-control form-control-sm" id="password" placeholder="(not required)">
            </div>
